...
router.get('/location', function(req, res){
    res.json({
        ...
        extId: padExtId(Math.floor(Math.random()*50)),
...
router.get('/location/:num', function(req, res){
...
router.get('/location/invalid/:num', function(req, res){
    let numLoc = req.params.num;
    let locations = [];
...
router.get('/location/invalid', function(req, res){
    res.json({
        uuid: faker.random.uuid(),
        extId: padExtId(Math.floor(Math.random()*50)),
        locationLevel: subvillage,
